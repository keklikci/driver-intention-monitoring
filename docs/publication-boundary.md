...
The public repository is intentionally data-independent. It excludes raw field data,
vehicle identifiers, employer-specific signal names, calibrated parameters, empirical
metrics, and deployment logic.
